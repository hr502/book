...
<form method="post" action="{{ route('admin.item.update', $item->id) }}" enctype="multipart/form-data">
    ...
    <form method="post" action="{{ route('admin.item.store') }}" enctype="multipart/form-data">
        ...
        <div class="col-sm-6 mt-4 mb-3">
            ...
            <input class="form-control mb-2" id="title" type="text" name="title" value="{{ old('title', $item->title)}}">
            @error('title')
        ...
        <div class="col-sm-6 mb-3">
            ...
            <input class="form-control mb-2" id="author" type="text" name="author" value="{{ old('author', $item->author)}}">
            @error('author')
                <li class="list-unstyled text-danger">{{ $message }}</li>
            @enderror
        </div>
        <div class="col-sm-6 mb-3">
            ...
            <input class="form-control mb-2" id="publisher" type="text" name="publisher" value="{{ old('publisher', $item->publisher)}}">
            @error('publisher')
                <li class="list-unstyled text-danger">{{ $message }}</li>
            @enderror
        </div>
        <div class="col-sm-6 mb-3">
            ...
            <input class="form-control mb-2" id="series" type="text" name="series" value="{{ old('series', $item->series)}}">
            @error('series')
                <li class="list-unstyled text-danger">{{ $message }}</li>
            @enderror
        </div>
        <div class="col-sm-6 mb-3">
            ...
            <textarea class="form-control mb-2" id="detail" type="text" name="detail">{{ old('detail', $item->detail)}}</textarea>
            @error('detail')
                <li class="list-unstyled text-danger">{{ $message }}</li>
            @enderror
        </div>
        <div class="col-sm-6 mb-3">
            ...
            <input class="form-control mb-2" id="published_on" type="text" name="published_on" value="{{ old('published_on', $item->published_on)}}">
            @error('published_on')
                <li class="list-unstyled text-danger">{{ $message }}</li>
            @enderror
        </div>
        <div class="col-sm-6 mb-3">
            ...
            <input class="form-control mb-2" id="classification" type="text" name="classification" value="{{ old('classification', $item->classification)}}">
        ...
        <div class="col-sm-6 mb-3">
            ...
            <input class="form-control mb-2" id="code" type="text" name="code" value="{{ old('code', $item->code)}}">
            @error('code')
                <li class="list-unstyled text-danger">{{ $message }}</li>
            @enderror
        </div>
        <div class="col-sm-6 mb-3">
            ...
            <input class="form-control mb-2" id="price" type="text" name="price" value="{{ old('price', $item->price)}}">
            @error('price')
                <li class="list-unstyled text-danger">{{ $message }}</li>
            @enderror
        </div>
        <div class="col-sm-6 mb-3">
            ...
            <select class="form-select" id="type" name="type">
                ...
                @foreach ($types as $type)
                    <option value="{{ $type->code }}" @if($type->code == old('type', $item->type_code)) selected @endif>{{ $type->name }}</option>
                @endforeach
            </select>
            @error('type')
                <li class="list-unstyled text-danger">{{ $message }}</li>
        ...
        <button class="btn btn-secondary mb-3" type="button"
            onclick="location.href='{{ route('admin.item.show', $item->id) }}'">キャンセル</button>
